...
class OfertaAcademicaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->area_id == 2){ 
            $colectivo = $request->colectivo_id;  
    ...
    public function edit($id){
        ...
        return view('livewire.oferta_academica.create', compact('titulo', 'butttonMessage', 'programas', 'colectivos','area','grupos', 'datos'));
      }
