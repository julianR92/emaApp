<nav class="navbar navbar-expand-lg fixed-top navbar-govco gov-co-1" style="height:48px;">
        <div class="navbar-container container pl-2" style="height:48px;">
              <div class="navbar-logo float-left">
                 <a class="navbar-brand" href="https://www.gov.co/" target="_blank" title="Ir al portal Gov.co">
                    <img src="https://cdn.www.gov.co/assets/images/logo.png" class="logo-gov-co" height="30" alt="Logo Gov.co" />
                 </a>
     ...
     <section class="container">
        <div class="row" style="padding-top: 6%;">
           <div class="col-md-4 col-sm-12 col-xs-12">
              ...
              <a href="https://www.imct.gov.co/"   target="_blank" title="Ir al Portal Instituto Municipal de Cultura y Turismo">               
                 <img src="{{ asset('assets/img/imct/IMCT-2.png') }}" class="img-imct" width="150px">               
              </a>
