...
<head>
   ...
   <!-- Favicons -->
   <link href="{{ asset('assets/img/imct/IMCT.png') }}" rel="icon">
   <link href="{{ asset('/assets/img/imct/IMCT.png') }}" rel="apple-touch-icon">
   ...
   @stack('programas-js')
   @stack('colectivos-js')
   @stack('instrumentos-js')
   @stack('asignaturas-js')
   @stack('mallas-js')
   @stack('mallas-asignaturas-js')
   @stack('mallas-colectivos-js')
   @stack('oferta-academica-js')
   @stack('docentes-js')
...
<body>
   @if (in_array(request()->route()->getName(),
       [
           ...
           'oferta-academica.nuevo',
           'oferta-academica.edit',
       ]))
      {{-- Nav --}}
      @include('layouts.nav')
      {{-- SideNav --}}
