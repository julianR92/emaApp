...
<div>
    ...
    <div class="card border-0 shadow mb-4">
        <div class="card-body">
            <h2 class="h5 mb-4">Información del docente</h2>
            <form action="#" method="#" id="myFormDoce">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            <label for="first_name">Nombres*</label>
                            <input name="nombres" onkeypress="return Letras(event)" type="text" class="form-control border-gray-300" placeholder="Ej: Andres" id="nombres"  autofocus required data-pristine-required-message="Campo Requerido" maxlength="15" @isset($datos) value="{{$datos->nombres}}"@endisset>
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input name="apellidos" onkeypress="return Letras(event)" type="text" class="form-control border-gray-300" placeholder="Ej: Pedroza" id="apellidos" required data-pristine-required-message="Campo Requerido" maxlength="15"  @isset($datos) value="{{$datos->apellidos}}"@endisset>
                        </div>
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            ...
                            <input  class="form-control" onchange="return Email(event)" name="correo" id="correo" type="mail"
                                placeholder="Ej: example@example.com" required data-pristine-required-message="Campo Requerido"  @isset($datos) value="{{$datos->correo}}"@endisset>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" onkeypress="return Letras(event)" name="profesion" id="profesion" type="text"
                                placeholder="Ej: Psicologo" maxlength="40"  @isset($datos) value="{{$datos->profesion}}"@endisset>
                        </div>
...
@push('docentes-js')
<script src="{{asset('js/profesores.js')}}" type="module"></script>
@endpush
