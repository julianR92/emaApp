    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                ...
                <p class="h5">{{$malla_programa[0]->cualificacion}}-{{$malla_programa[0]->numero_cualificacion}}  COLECTIVO {{$malla_programa[0]->colectivo}}</p>
                <p class="h6">NIVEL {{$malla_programa[0]->nivel}}</p>
            </div>   
            <div>
